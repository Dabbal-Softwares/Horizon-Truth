          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Empowering Minds, <span className="text-sky-500">Fighting Misinformation</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link to="/game" className="bg-sky-500 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 text-center shadow-lg">
                  Start the Game
                </Link>
                <Link to="/about" className="bg-white hover:bg-gray-100 text-sky-500 font-semibold py-3 px-8 rounded-lg transition duration-300 text-center shadow-lg border border-sky-500">
                  Learn More
                </Link>
              </div>
            </div>

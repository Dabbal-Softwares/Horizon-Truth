    ...
    <section className="py-16 bg-gradient-to-r from-sky-500 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="https://truth.debbal.com/game" className="bg-white hover:bg-gray-100 text-sky-600 font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-lg">
                    Try Our Game
                </a>
                <a href="https://truth.debbal.com/contact" className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-lg transition duration-300 shadow-lg border border-white">
                    Contact Us
                </a>
            </div>
        </div>

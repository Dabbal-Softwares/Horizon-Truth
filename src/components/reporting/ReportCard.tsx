      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center mb-4">
            <span
              className={`${config?.className} text-xs font-medium px-2.5 py-0.5 rounded`}
            >
              {config?.label}
            </span>
            <span className="ml-4 text-sm text-gray-500">
              Posted {report.postedTime}
            </span>
          </div>
          ...
          <div className="flex items-center text-sm text-gray-500">
            <span className="mr-6">
              <i className="fas fa-tag mr-1"></i> {report.category}
            </span>
            <span>
              <i className="fas fa-users mr-1"></i> {report.reviewers} reviewers
            </span>
          </div>
        </div>
        <div className="mt-4 md:mt-0 md:ml-6">
          <button
            className={`${config?.buttonClass} px-4 py-2 rounded-lg transition duration-300 whitespace-nowrap`}
          >
            {config?.buttonText}
          </button>
        </div>
